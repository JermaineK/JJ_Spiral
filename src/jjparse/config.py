...
DEFAULT_CONFIG = {
    ...
    "null_models": {
        "direction_n": 150,
        "direction_max_segments": 300,
        "phase_n": 50,
        "phase_max_segments": 300,
        "parity_boot": 200,
        "z_boot": 500,
        "seed": 123,
    ...
    "phase6": {
        ...
        "sensitivity": {
            "min_overlap": [0.2, 0.35, 0.5, 0.65, 0.8],
            "grid_method": ["linear", "pchip"],
    ...
    "phase7": {
        ...
        "nulls": {
            ...
            "pairing_n": 200,
            "pairing_samples": 200,
            "nuisance_samples": 200,
            "seed": 123,
        },
        "nuisance": {
            "piecewise_slope": 0.15,
            "offset_frac": 0.02,
            "loop_squash": 0.1,
            "v_offset_frac": 0.05,
        },
